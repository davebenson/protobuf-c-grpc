...
DskDnsMessage *
pbc_grpc_dsk_dns_message_parse (unsigned       length,
                       const uint8_t *data,
                       DskError     **error)
{
  DskDnsHeader header;
...
uint8_t *
pbc_grpc_dsk_dns_message_serialize (DskDnsMessage *message,
                           unsigned      *length_out)
{
...
void
pbc_grpc_dsk_dns_message_dump (DskDnsMessage *message)
{
  unsigned i;
  printf ("id: %u\n"
          "is_query: %u\n"
